...
export const SecurityGetBuiltinPrivilegesResponse = z.object({
  ...
  remote_cluster: z.array(SecurityRemoteClusterPrivilege).describe('The list of remote_cluster privileges that are understood by this version of Elasticsearch.')

...
export interface IndicesIndexSettingsShape {
  ...
  number_of_shards?: integer | string | undefined
  number_of_replicas?: integer | string | undefined
...
export const IndicesIndexSettings = z.looseObject({
  ...
  number_of_shards: z.union([integer, z.string()]).optional(),
  number_of_replicas: z.union([integer, z.string()]).optional(),
...
export const IndicesIndexTemplateSummary = z.object({
  ...
  mappings: MappingTypeMapping.describe('Mapping for fields in the index. If specified, this mapping can include field names, field data types, and mapping parameters.').optional(),
...
export const SimulateIngestIngestDocumentSimulation = z.object({
  ...
  effective_mapping: MappingTypeMapping.optional()
...
export const SimulateIngestRequest = z.object({
  ...
  mapping_addition: MappingTypeMapping.optional().meta({ found_in: 'body' }),

...
export const IndicesPutDataStreamMappingsRequest = z.object({
  ...
  mappings: MappingTypeMapping.meta({ found_in: 'body' })
...
export const IndicesPutDataStreamMappingsUpdatedDataStreamMappings = z.object({
  ...
  mappings: MappingTypeMapping.describe('The mappings that are specfic to this data stream that will override any mappings from the matching index template.').optional(),
  effective_mappings: MappingTypeMapping.describe('The mappings that are effective on this data stream, taking into account the mappings from the matching index template and the mappings specific to this data stream.').optional()

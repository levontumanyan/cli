...
export const IndicesGetDataStreamMappingsDataStreamMappings = z.object({
  ...
  mappings: MappingTypeMapping.describe('The settings specific to this data stream'),
  effective_mappings: MappingTypeMapping.describe('The settings specific to this data stream merged with the settings from its template. These `effective_settings` are the settings that will be used when a new index is created for this data stream.')

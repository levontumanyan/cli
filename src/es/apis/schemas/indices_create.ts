...
export const IndicesCreateRequest = z.object({
  ...
  mappings: MappingTypeMapping.describe('Mapping for fields in the index. If specified, this mapping can include: - Field names - Field data types - Mapping parameters').optional().meta({ found_in: 'body' }),

...
import type { SearchFieldCollapseShape, SearchHighlightShape, SearchInnerHitsShape, SearchRescoreShape, SearchSearchRequestBodyShape } from './_global.ts'
import { SpecUtilsPipeSeparatedFlags, SpecUtilsStringified } from './_spec_utils.ts'
import { ClusterAllocationExplainUnassignedInformation } from './cluster.ts'
import { IndicesFielddataFrequencyFilter, IndicesNumericFielddata, IndicesStatsShardFileSizeInfo, IndicesStatsShardRoutingState } from './indices.ts'
...
export const QueryDslCommonTermsQuery = z.object({
  ...
  cutoff_frequency: z.lazy(() => double).optional(),
...
export const QueryDslCombinedFieldsQuery = z.object({
  ...QueryDslQueryBase.shape,
  fields: z.array(z.lazy(() => Field)).describe('List of fields to search. Field wildcard patterns are allowed. Only `text` fields are supported, and they must all have the same search `analyzer`.'),
...
export const QueryDslFieldValueFactorScoreFunction = z.object({
  field: z.lazy(() => Field).describe('Field to be extracted from the document.'),
...
export const QueryDslFunctionScoreQuery = z.object({
  ...
  max_boost: z.lazy(() => double).describe('Restricts the new score to not exceed the provided limit.').optional(),
...
export const QueryDslFuzzyQuery = z.object({
  ...QueryDslQueryBase.shape,
  max_expansions: z.lazy(() => integer).describe('Maximum number of variations created.').optional(),
  prefix_length: z.lazy(() => integer).describe('Number of beginning characters left unchanged when creating expansions.').optional(),
...
export const QueryDslHasChildQuery = z.object({
  ...
  max_children: z.lazy(() => integer).describe('Maximum number of child documents that match the query allowed for a returned parent document. If the parent document exceeds this limit, it is excluded from the search results.').optional(),
  min_children: z.lazy(() => integer).describe('Minimum number of child documents that match the query required to match the query for a returned parent document. If the parent document does not meet this limit, it is excluded from the search results.').optional(),
...
export const QueryDslIntervalsMatch = z.object({
  ...
  max_gaps: z.lazy(() => integer).describe('Maximum number of positions between the matching terms. Terms further apart than this are not considered matches.').optional(),
...
export const QueryDslMatchQuery = z.object({
  ...
  max_expansions: z.lazy(() => integer).describe('Maximum number of terms to which the query will expand.').optional(),
  minimum_should_match: MinimumShouldMatch.describe('Minimum number of clauses that must match for a document to be returned.').optional(),
...
export const QueryDslMatchBoolPrefixQuery = z.object({
  ...QueryDslQueryBase.shape,
  analyzer: z.string().describe('Analyzer used to convert the text in the query value into tokens.').optional(),
  fuzziness: z.lazy(() => Fuzziness).describe('Maximum edit distance allowed for matching. Can be applied to the term subqueries constructed for all terms but the final term.').optional(),
  ...
  max_expansions: z.lazy(() => integer).describe('Maximum number of terms to which the query will expand. Can be applied to the term subqueries constructed for all terms but the final term.').optional(),
...
export const QueryDslMatchPhrasePrefixQuery = z.object({
  ...
  max_expansions: z.lazy(() => integer).describe('Maximum number of terms to which the last provided term of the query value will expand.').optional(),
  query: z.string().describe('Text you wish to find in the provided field.'),
  slop: z.lazy(() => integer).describe('Maximum number of positions allowed between matching tokens.').optional(),
  zero_terms_query: QueryDslZeroTermsQuery.describe('Indicates whether no documents are returned if the analyzer removes all tokens, such as when using a `stop` filter.').optional()
...
export const QueryDslLikeDocument = z.object({
  ...
  _id: z.lazy(() => Id).describe('ID of a document.').optional(),
  _index: z.lazy(() => IndexName).describe('Index of a document.').optional(),
  per_field_analyzer: z.record(z.lazy(() => Field), z.string()).describe('Overrides the default analyzer.').optional(),
...
export const QueryDslMoreLikeThisQuery = z.object({
  ...
  boost_terms: z.lazy(() => double).describe('Each term in the formed query could be further boosted by their tf-idf score. This sets the boost factor to use when using this feature. Defaults to deactivated (0).').optional(),
  ...
  fields: z.array(z.lazy(() => Field)).describe('A list of fields to fetch and analyze the text from. Defaults to the `index.query.default_field` index setting, which has a default value of `*`.').optional(),
  ...
  max_doc_freq: z.lazy(() => integer).describe('The maximum document frequency above which the terms are ignored from the input document.').optional(),
  max_query_terms: z.lazy(() => integer).describe('The maximum number of query terms that can be selected.').optional(),
  max_word_length: z.lazy(() => integer).describe('The maximum word length above which the terms are ignored. Defaults to unbounded (`0`).').optional(),
  min_doc_freq: z.lazy(() => integer).describe('The minimum document frequency below which the terms are ignored from the input document.').optional(),
  ...
  min_term_freq: z.lazy(() => integer).describe('The minimum term frequency below which the terms are ignored from the input document.').optional(),
  min_word_length: z.lazy(() => integer).describe('The minimum word length below which the terms are ignored.').optional(),
...
export const QueryDslMultiMatchQuery = z.object({
  ...
  auto_generate_synonyms_phrase_query: z.boolean().describe('If `true`, match phrase queries are automatically created for multi-term synonyms.').optional(),
  cutoff_frequency: z.lazy(() => double).optional(),
  fields: z.lazy(() => Fields).describe('The fields to be queried. Defaults to the `index.query.default_field` index settings, which in turn defaults to `*`.').optional(),
  fuzziness: z.lazy(() => Fuzziness).describe('Maximum edit distance allowed for matching.').optional(),
  fuzzy_rewrite: MultiTermQueryRewrite.describe('Method used to rewrite the query.').optional(),
  fuzzy_transpositions: z.boolean().describe('If `true`, edits for fuzzy matching include transpositions of two adjacent characters (for example, `ab` to `ba`). Can be applied to the term subqueries constructed for all terms but the final term.').optional(),
  lenient: z.boolean().describe('If `true`, format-based errors, such as providing a text query value for a numeric field, are ignored.').optional(),
...
export const QueryDslPercolateQuery = z.object({
  ...
  field: z.lazy(() => Field).describe('Field that holds the indexed queries. The field must use the `percolator` mapping type.'),
  id: z.lazy(() => Id).describe('The ID of a stored document to percolate.').optional(),
  index: z.lazy(() => IndexName).describe('The index of a stored document to percolate.').optional(),
...
const QueryDslPinnedQueryExclusiveProps = z.union([z.object({ ids: z.array(z.lazy(() => Id)) }), z.object({ docs: z.array(QueryDslPinnedDoc) })])
...
export const QueryDslQueryStringQuery = z.object({
  ...
  auto_generate_synonyms_phrase_query: z.boolean().describe('If `true`, match phrase queries are automatically created for multi-term synonyms.').optional(),
  default_field: z.lazy(() => Field).describe('Default field to search if no field is provided in the query string. Supports wildcards (`*`). Defaults to the `index.query.default_field` index setting, which has a default value of `*`.').optional(),
  ...
  fields: z.array(z.lazy(() => Field)).describe('Array of fields to search. Supports wildcards (`*`).').optional(),
  fuzziness: z.lazy(() => Fuzziness).describe('Maximum edit distance allowed for fuzzy matching.').optional(),
  fuzzy_max_expansions: z.lazy(() => integer).describe('Maximum number of terms to which the query expands for fuzzy matching.').optional(),
  fuzzy_prefix_length: z.lazy(() => integer).describe('Number of beginning characters left unchanged for fuzzy matching.').optional(),
  fuzzy_rewrite: MultiTermQueryRewrite.describe('Method used to rewrite the query.').optional(),
  fuzzy_transpositions: z.boolean().describe('If `true`, edits for fuzzy matching include transpositions of two adjacent characters (for example, `ab` to `ba`).').optional(),
  ...
  minimum_should_match: MinimumShouldMatch.describe('Minimum number of clauses that must match for a document to be returned.').optional(),
  phrase_slop: z.lazy(() => double).describe('Maximum number of positions allowed between matching tokens for phrases.').optional(),
...
export const QueryDslRankFeatureQuery = z.object({
  ...QueryDslQueryBase.shape,
  field: z.lazy(() => Field).describe('`rank_feature` or `rank_features` field used to boost relevance scores.'),
...
export const QueryDslSimpleQueryStringQuery = z.object({
  ...
  default_operator: z.lazy(() => QueryDslOperator).describe('Default boolean logic used to interpret text in the query string if no operators are specified.').optional(),
  fields: z.array(z.lazy(() => Field)).describe('Array of fields you wish to search. Accepts wildcard expressions. You also can boost relevance scores for matches to particular fields using a caret (`^`) notation. Defaults to the `index.query.default_field index` setting, which has a default value of `*`.').optional(),
...
export const QueryDslSpanNotQuery = z.object({
  boost: z.lazy(() => float).describe('Floating point number used to decrease or increase the relevance scores of the query. Boost values are relative to the default value of 1.0. A boost value between 0 and 1.0 decreases the relevance score. A value greater than 1.0 increases the relevance score.').optional(),
  query_name: z.string().optional(),
  dist: z.lazy(() => integer).describe('The number of tokens from within the include span that can’t have overlap with the exclude span. Equivalent to setting both `pre` and `post`.').optional(),
...
const QueryDslSparseVectorQueryCommonProps = z.object({
  field: z.lazy(() => Field).describe('The name of the field that contains the token-weight pairs to be searched against. This field must be a mapped sparse_vector field.'),
...
export const AggregationsAutoDateHistogramAggregation = z.object({
  buckets: z.lazy(() => integer).describe('The target number of buckets.').optional(),
  ...
  missing: z.lazy(() => DateTime).describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
...
export const AggregationsBucketSortAggregation = z.object({
  from: z.lazy(() => integer).describe('Buckets in positions prior to `from` will be truncated.').optional(),
...
export const AggregationsCategorizeTextAggregation = z.object({
  field: z.lazy(() => Field).describe('The semi-structured text field to categorize.'),
  max_unique_tokens: z.lazy(() => integer).describe('The maximum number of unique tokens at any position up to max_matched_tokens. Must be larger than 1. Smaller values use less memory and create fewer categories. Larger values will use more memory and create narrower categories. Max allowed value is 100.').optional(),
  max_matched_tokens: z.lazy(() => integer).describe('The maximum number of token positions to match on before attempting to merge categories. Larger values will use more memory and create narrower categories. Max allowed value is 100.').optional(),
  similarity_threshold: z.lazy(() => integer).describe('The minimum percentage of tokens that must match for text to be added to the category bucket. Must be between 1 and 100. The larger the value the narrower the categories. Larger values will increase memory usage and create narrower categories.').optional(),
  ...
  shard_size: z.lazy(() => integer).describe('The number of categorization buckets to return from each shard before merging all the results.').optional(),
...
export const AggregationsDateHistogramAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('The date field whose values are use to build a histogram.').optional(),
  fixed_interval: z.lazy(() => Duration).describe('Fixed intervals: a fixed number of SI units and never deviate, regardless of where they fall on the calendar.').optional(),
  format: z.string().describe('The date format used to format `key_as_string` in the response. If no `format` is specified, the first date format specified in the field mapping is used.').optional(),
  interval: z.lazy(() => Duration).optional(),
  min_doc_count: z.lazy(() => integer).describe('Only returns buckets that have `min_doc_count` number of documents. By default, all buckets between the first bucket that matches documents and the last one are returned.').optional(),
  missing: z.lazy(() => DateTime).describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
  offset: z.lazy(() => Duration).describe('Changes the start value of each bucket by the specified positive (`+`) or negative offset (`-`) duration.').optional(),
...
export const AggregationsDiversifiedSamplerAggregation = z.object({
  ...
  max_docs_per_value: z.lazy(() => integer).describe('Limits how many documents are permitted per choice of de-duplicating value.').optional(),
  get script () { return Script.optional() },
...
export const AggregationsFrequentItemSetsAggregation = z.object({
  ...
  minimum_set_size: z.lazy(() => integer).describe('The minimum size of one item set.').optional(),
...
export const AggregationsGeoDistanceAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('A field of type `geo_point` used to evaluate the distance.').optional(),
...
export const AggregationsGeoHashGridAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('Field containing indexed `geo_point` or `geo_shape` values. If the field contains an array, `geohash_grid` aggregates all array values.').optional(),
...
export const AggregationsGeoTileGridAggregation = z.object({
  ...AggregationsBucketAggregationBase.shape,
  field: z.lazy(() => Field).describe('Field containing indexed `geo_point` or `geo_shape` values. If the field contains an array, `geotile_grid` aggregates all array values.').optional(),
...
export const AggregationsGeohexGridAggregation = z.object({
  ...AggregationsBucketAggregationBase.shape,
  field: z.lazy(() => Field).describe('Field containing indexed `geo_point` or `geo_shape` values. If the field contains an array, `geohex_grid` aggregates all array values.'),
  precision: z.lazy(() => integer).describe('Integer zoom of the key used to defined cells or buckets in the results. Value should be between 0-15.').optional(),
...
export const AggregationsHistogramAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('The name of the field to aggregate on.').optional(),
  interval: z.lazy(() => double).describe('The interval for the buckets. Must be a positive decimal.').optional(),
  min_doc_count: z.lazy(() => integer).describe('Only returns buckets that have `min_doc_count` number of documents. By default, the response will fill gaps in the histogram with empty buckets.').optional(),
  missing: z.lazy(() => double).describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
  offset: z.lazy(() => double).describe('By default, the bucket keys start with 0 and then continue in even spaced steps of `interval`. The bucket boundaries can be shifted by using the `offset` option.').optional(),
...
export const AggregationsIpPrefixAggregation = z.object({
  ...AggregationsBucketAggregationBase.shape,
  field: z.lazy(() => Field).describe('The IP address field to aggregation on. The field mapping type must be `ip`.'),
  prefix_length: z.lazy(() => integer).describe('Length of the network prefix. For IPv4 addresses the accepted range is [0, 32]. For IPv6 addresses the accepted range is [0, 128].'),
...
const AggregationsMultiTermLookupExclusiveProps = z.union([z.object({ field: z.lazy(() => Field) }), z.object({ script: z.lazy(() => Script) })])
...
export const AggregationsMultiTermsAggregation = z.object({
  ...
  min_doc_count: z.lazy(() => long).describe('The minimum number of documents in a bucket for it to be returned.').optional(),
  shard_min_doc_count: z.lazy(() => long).describe('The minimum number of documents in a bucket on each shard for it to be returned.').optional(),
...
export const AggregationsRareTermsAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('The field from which to return rare terms.').optional(),
  include: AggregationsTermsInclude.describe('Terms that should be included in the aggregation.').optional(),
  max_doc_count: z.lazy(() => long).describe('The maximum number of documents a term should appear in.').optional(),
  missing: AggregationsMissing.describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
...
export const AggregationsSignificantTermsAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('The field from which to return significant terms.').optional(),
  ...
  min_doc_count: z.lazy(() => long).describe('Only return terms that are found in more than `min_doc_count` hits.').optional(),
...
export const AggregationsSignificantTextAggregation = z.object({
  ...
  field: z.lazy(() => Field).describe('The field from which to return significant text.').optional(),
  ...
  jlh: EmptyObject.describe('Use JLH score as the significance score.').optional(),
  min_doc_count: z.lazy(() => long).describe('Only return values that are found in more than `min_doc_count` hits.').optional(),
  mutual_information: AggregationsMutualInformationHeuristic.describe('Use mutual information as described in "Information Retrieval", Manning et al., Chapter 13.5.1, as the significance score.').optional(),
  percentage: AggregationsPercentageScoreHeuristic.describe('A simple calculation of the number of documents in the foreground sample with a term divided by the number of documents in the background with the term.').optional(),
  get script_heuristic () { return AggregationsScriptedHeuristic.describe('Customized score, implemented via a script.').optional() },
  shard_min_doc_count: z.lazy(() => long).describe('Regulates the certainty a shard has if the values should actually be added to the candidate list or not with respect to the min_doc_count. Values will only be considered if their local shard frequency within the set is higher than the `shard_min_doc_count`.').optional(),
  shard_size: z.lazy(() => integer).describe('The number of candidate terms produced by each shard. By default, `shard_size` will be automatically estimated based on the number of shards and the `size` parameter.').optional(),
  size: z.lazy(() => integer).describe('The number of buckets returned out of the overall terms list.').optional(),
...
export const AggregationsTermsAggregation = z.object({
  ...
  execution_hint: AggregationsTermsAggregationExecutionHint.describe('Determines whether the aggregation will use field values directly or global ordinals.').optional(),
  field: z.lazy(() => Field).describe('The field from which to return terms.').optional(),
  include: AggregationsTermsInclude.describe('Values to include. Accepts regular expressions and partitions.').optional(),
  min_doc_count: z.lazy(() => integer).describe('Only return values that are found in more than `min_doc_count` hits.').optional(),
  missing: AggregationsMissing.describe('The value to apply to documents that do not have a value. By default, documents without a value are ignored.').optional(),
  missing_order: AggregationsMissingOrder.optional(),
  missing_bucket: z.boolean().optional(),
...
export const AggregationsTopHitsAggregation = z.object({
  ...
  from: z.lazy(() => integer).describe('Starting document offset.').optional(),
  ...
  size: z.lazy(() => integer).describe('The maximum number of top matching hits to return per bucket.').optional(),
  ...
  stored_fields: z.lazy(() => Fields).describe('Returns values for the specified stored fields (fields that use the `store` mapping option).').optional(),
...
export const KnnRetriever = z.object({
  ...
  num_candidates: z.lazy(() => integer).describe('Number of nearest neighbor candidates to consider per shard.'),
  visit_percentage: z.lazy(() => float).describe('The percentage of vectors to explore per shard while doing knn search with bbq_disk').optional(),
...
export const MappingRuntimeField = z.object({
  ...
  input_field: z.lazy(() => Field).describe('For type `lookup`').optional(),
  target_field: z.lazy(() => Field).describe('For type `lookup`').optional(),
...
export const ReindexStatus = z.object({
  ...
  retries: z.lazy(() => Retries).describe('The number of retries attempted by reindex. `bulk` is the number of bulk actions retried and `search` is the number of search actions retried.'),
...
export const ElasticsearchVersionInfo = z.object({
  build_date: z.lazy(() => DateTime).describe('The Elasticsearch Git commit\'s date.'),
  ...
  lucene_version: z.lazy(() => VersionString).describe('The version number of Elasticsearch\'s underlying Lucene software.'),
...
export const AggregationsStatsAggregate = z.object({
  ...AggregationsAggregateBase.shape,
  count: z.lazy(() => long),
  min: z.union([z.lazy(() => double), z.null()]),
  max: z.union([z.lazy(() => double), z.null()]),
  avg: z.union([z.lazy(() => double), z.null()]),
  sum: z.lazy(() => double),
...
export const AggregationsStandardDeviationBounds = z.object({
  upper: z.union([z.lazy(() => double), z.null()]),
  lower: z.union([z.lazy(() => double), z.null()]),
  upper_population: z.union([z.lazy(() => double), z.null()]),
...
export const AggregationsExtendedStatsAggregate = z.object({
  ...AggregationsStatsAggregate.shape,
  sum_of_squares: z.union([z.lazy(() => double), z.null()]),
  variance: z.union([z.lazy(() => double), z.null()]),
  variance_population: z.union([z.lazy(() => double), z.null()]),
  variance_sampling: z.union([z.lazy(() => double), z.null()]),
  std_deviation: z.union([z.lazy(() => double), z.null()]),
  std_deviation_population: z.union([z.lazy(() => double), z.null()]),
  std_deviation_sampling: z.union([z.lazy(() => double), z.null()]),
...
export const AggregationsInferenceAggregate = z.object({
  meta: z.lazy(() => Metadata).optional(),
  value: z.lazy(() => FieldValue).optional(),
...
export const AggregationsStringStatsAggregate = z.object({
  ...AggregationsAggregateBase.shape,
  count: z.lazy(() => long),
  min_length: z.union([z.lazy(() => integer), z.null()]),
  max_length: z.union([z.lazy(() => integer), z.null()]),
  avg_length: z.union([z.lazy(() => double), z.null()]),
  entropy: z.union([z.lazy(() => double), z.null()]),
  distribution: z.union([z.record(z.string(), z.lazy(() => double)), z.null()]).optional(),
...
export const AggregationsMatrixStatsFields = z.object({
  ...
  count: z.lazy(() => long),
  mean: z.lazy(() => double),
  variance: z.lazy(() => double),
  skewness: z.lazy(() => double),
...
export const AggregationsRangeBucket = z.object({
  doc_count: z.lazy(() => long),
  from: z.lazy(() => double).optional(),
  to: z.lazy(() => double).optional(),
...
export const AnalysisFingerprintAnalyzer = z.object({
  ...
  max_output_size: z.lazy(() => integer).describe('The maximum token size to emit. Tokens larger than this size will be discarded. Defaults to `255`').optional(),
...
export const AnalysisCompoundWordTokenFilterBase = z.object({
  ...AnalysisTokenFilterBase.shape,
  max_subword_size: z.lazy(() => integer).describe('Maximum subword character length. Longer subword tokens are excluded from the output. Defaults to `15`.').optional(),
  min_subword_size: z.lazy(() => integer).describe('Minimum subword character length. Shorter subword tokens are excluded from the output. Defaults to `2`.').optional(),
  min_word_size: z.lazy(() => integer).describe('Minimum word character length. Shorter word tokens are excluded from the output. Defaults to `5`.').optional(),
...
export const AnalysisEdgeNGramTokenFilter = z.object({
  ...
  max_gram: z.lazy(() => integer).describe('Maximum character length of a gram. For custom token filters, defaults to `2`. For the built-in edge_ngram filter, defaults to `1`.').optional(),
...
export const AnalysisKuromojiTokenizer = z.object({
  ...
  nbest_cost: z.lazy(() => integer).optional(),
...
export const AnalysisMinHashTokenFilter = z.object({
  ...
  bucket_count: z.lazy(() => integer).describe('Number of buckets to which hashes are assigned. Defaults to `512`.').optional(),
...
export const AnalysisPathHierarchyTokenizer = z.object({
  ...
  buffer_size: z.lazy(() => SpecUtilsStringified).optional(),
...
export const AnalysisPhoneticTokenFilter = z.object({
  ...
  max_code_len: z.lazy(() => integer).optional(),
...
export const AnalysisShingleTokenFilter = z.object({
  ...
  max_shingle_size: z.lazy(() => SpecUtilsStringified).describe('Maximum number of tokens to concatenate when creating shingles. Defaults to `2`.').optional(),
  min_shingle_size: z.lazy(() => SpecUtilsStringified).describe('Minimum number of tokens to concatenate when creating shingles. Defaults to `2`.').optional(),
...
export const AnalysisWordDelimiterTokenFilterBase = z.object({
  ...
  preserve_original: z.lazy(() => SpecUtilsStringified).describe('If `true`, the filter includes the original version of any split tokens in the output. This original version includes non-alphanumeric delimiters. Defaults to `false`.').optional(),
...
export const MappingSemanticTextProperty = z.object({
  ...
  inference_id: z.lazy(() => Id).describe('Inference endpoint that will be used to generate embeddings for the field. This parameter cannot be updated. Use the Create inference API to create the endpoint. If `search_inference_id` is specified, the inference endpoint will only be used at index time.').optional(),
  search_inference_id: z.lazy(() => Id).describe('Inference endpoint that will be used to generate embeddings at query time. You can update this parameter by using the Update mapping API. Use the Create inference API to create the endpoint. If not specified, the inference endpoint defined by inference_id will be used at both index and query time.').optional(),
...
export const MappingCompletionProperty = z.object({
  ...
  max_input_length: z.lazy(() => integer).optional(),
...
export const MappingDenseVectorProperty = z.object({
  ...
  dims: z.lazy(() => integer).describe('Number of vector dimensions. Can\'t exceed `4096`. If `dims` is not specified, it will be set to the length of the first vector added to the field.').optional(),
...
export const MappingDynamicProperty = z.object({
  ...
  null_value: z.lazy(() => FieldValue).optional(),
  boost: z.lazy(() => double).optional(),
  coerce: z.boolean().optional(),
  get script () { return Script.optional() },
  on_script_error: MappingOnScriptError.optional(),
...
export const MappingFlattenedProperty = z.object({
  ...
  synthetic_source_keep: MappingSyntheticSourceKeepEnum.optional(),
  boost: z.lazy(() => double).optional(),
  depth_limit: z.lazy(() => integer).optional(),
  doc_values: z.boolean().optional(),
  eager_global_ordinals: z.boolean().optional(),
  index: z.boolean().optional(),
  index_options: MappingIndexOptions.optional(),
...
export const MappingGeoPointProperty = z.object({
  ...
  null_value: z.lazy(() => GeoLocation).optional(),
  index: z.boolean().optional(),
  on_script_error: MappingOnScriptError.optional(),
  get script () { return Script.optional() },
...
export const MappingSearchAsYouTypeProperty = z.object({
  ...
  index: z.boolean().optional(),
  index_options: MappingIndexOptions.optional(),
  max_shingle_size: z.lazy(() => integer).optional(),
  norms: z.boolean().optional(),
  search_analyzer: z.string().optional(),
  search_quote_analyzer: z.string().optional(),
  similarity: z.union([z.string(), z.null()]).optional(),
...
export const QueryDslDecayPlacement = z.object({
  decay: z.lazy(() => double).describe('Defines how documents are scored at the distance given at scale.').optional(),
...
export const QueryDslFieldLookup = z.object({
  id: z.lazy(() => Id).describe('`id` of the document.'),

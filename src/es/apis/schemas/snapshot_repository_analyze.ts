...
export const SnapshotRepositoryAnalyzeRequest = z.object({
  ...
  check_overwrite_protection: z.boolean().describe('Whether to run the overwrite protection check. For realistic experiments, leave this parameter unset.').optional().meta({ found_in: 'query' }),

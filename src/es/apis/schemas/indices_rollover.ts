...
export const IndicesRolloverRequest = z.object({
  ...
  mappings: MappingTypeMapping.describe('Mapping for fields in the index. If specified, this mapping can include field names, field data types, and mapping paramaters.').optional().meta({ found_in: 'body' }),

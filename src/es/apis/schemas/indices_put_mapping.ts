...
export const MappingDenseVectorIndexOptions = z.object({
  ...
  on_disk_rescore: z.boolean().describe('`true` if vector rescoring should be done on-disk Only applicable to `bbq_disk`, `bbq_hnsw`, `int4_hnsw`, `int8_hnsw`').optional()
...
export const IndicesPutMappingRequest = z.object({
  ...
  dynamic: MappingDynamicMapping.describe('Controls whether new fields are added dynamically.').optional().meta({ found_in: 'body' }),
  ...
  dynamic_templates: z.array(z.record(z.string(), MappingDynamicTemplate)).describe('Specify dynamic templates for the mapping.').optional().meta({ found_in: 'body' }),
  _field_names: MappingFieldNamesField.describe('Control whether field names are enabled for the index.').optional().meta({ found_in: 'body' }),
  ...
  _routing: MappingRoutingField.describe('Enable making a routing value required on indexed documents.').optional().meta({ found_in: 'body' }),
  _source: MappingSourceField.describe('Control whether the _source field is enabled on the index.').optional().meta({ found_in: 'body' }),

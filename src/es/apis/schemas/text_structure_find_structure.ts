...
export const TextStructureFindStructureRequest = z.object({
  ...
  text_files: z.array(z.any()).meta({ found_in: 'body' })
...
export const TextStructureFindStructureResponse = z.object({
  ...
  mappings: MappingTypeMapping.describe('Some suitable mappings for an index into which the data could be ingested.'),

...
import { ExpandWildcards, Field, Fields, IndexName, Indices, Metadata, RequestBase } from './_types.ts'
import { MappingRuntimeFields, MappingTimeSeriesMetricType } from './_types.mapping.ts'

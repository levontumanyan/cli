...
import { MsearchMultiSearchResult, MsearchMultisearchHeader } from './_global.msearch.ts'
import { ScriptSource } from './_global.search.ts'
import { Id, Indices, RequestBase, SearchType, long } from './_types.ts'

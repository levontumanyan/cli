...
export const MlAnomalyExplanation = z.object({
  anomaly_characteristics_impact: z.lazy(() => integer).describe('Impact from the duration and magnitude of the detected anomaly relative to the historical average.').optional(),
  anomaly_length: z.lazy(() => integer).describe('Length of the detected anomaly in the number of buckets.').optional(),
  ...
  lower_confidence_bound: z.lazy(() => double).describe('Lower bound of the 95% confidence interval.').optional(),
  multi_bucket_impact: z.lazy(() => integer).describe('Impact of the deviation between actual and typical values in the past 12 buckets.').optional(),
...
export const MlAnomaly = z.object({
  actual: z.array(z.lazy(() => double)).describe('The actual value for the bucket.').optional(),
  ...
  bucket_span: z.lazy(() => DurationValue).describe('The length of the bucket in seconds. This value matches the `bucket_span` that is specified in the job.'),
  ...
  detector_index: z.lazy(() => integer).describe('A unique identifier for the detector.'),
  ...
  initial_record_score: z.lazy(() => double).describe('A normalized score between 0-100, which is based on the probability of the anomalousness of this record. This is the initial value that was calculated at the time the bucket was processed.'),
  ...
  probability: z.lazy(() => double).describe('The probability of the individual anomaly occurring, in the range 0 to 1. For example, `0.0000772031`. This value can be held to a high precision of over 300 decimal places, so the `record_score` is provided as a human-readable and friendly interpretation of this.'),
  record_score: z.lazy(() => double).describe('A normalized score between 0-100, which is based on the probability of the anomalousness of this record. Unlike `initial_record_score`, this value will be updated by a re-normalization process as new data is analyzed.'),
...
export const MlRunningStateSearchInterval = z.object({
  end: z.lazy(() => Duration).describe('The end time.').optional(),
...
export const MlDatafeedTimingStats = z.object({
  bucket_count: z.lazy(() => long).describe('The number of buckets processed.'),
  exponential_average_search_time_per_hour_ms: z.lazy(() => DurationValue).describe('The exponential average search time per hour, in milliseconds.'),
...
export const MlDatafeedStats = z.object({
  ...
  datafeed_id: z.lazy(() => Id).describe('A numerical character string that uniquely identifies the datafeed. This identifier can contain lowercase alphanumeric characters (a-z and 0-9), hyphens, and underscores. It must start and end with alphanumeric characters.'),
...
export const MlHyperparameters = z.object({
  ...
  feature_bag_fraction: z.lazy(() => double).describe('Advanced configuration option. Defines the fraction of features that will be used when selecting a random bag for each candidate split. By default, this value is calculated during hyperparameter optimization.').optional(),
  downsample_factor: z.lazy(() => double).describe('Advanced configuration option. Controls the fraction of data that is used to compute the derivatives of the loss function for tree training. A small value results in the use of a small fraction of the data. If this value is set to be less than 1, accuracy typically improves. However, too small a value may result in poor convergence for the ensemble and so require more trees. By default, this value is calculated during hyperparameter optimization. It must be greater than zero and less than or equal to 1.').optional(),
  max_attempts_to_add_tree: z.lazy(() => integer).describe('If the algorithm fails to determine a non-trivial tree (more than a single leaf), this parameter determines how many of such consecutive failures are tolerated. Once the number of attempts exceeds the threshold, the forest training stops.').optional(),
  max_optimization_rounds_per_hyperparameter: z.lazy(() => integer).describe('Advanced configuration option. A multiplier responsible for determining the maximum number of hyperparameter optimization steps in the Bayesian optimization procedure. The maximum number of steps is determined based on the number of undefined hyperparameters times the maximum optimization rounds per hyperparameter. By default, this value is calculated during hyperparameter optimization.').optional(),
  max_trees: z.lazy(() => integer).describe('Advanced configuration option. Defines the maximum number of decision trees in the forest. The maximum value is 2000. By default, this value is calculated during hyperparameter optimization.').optional(),
  num_folds: z.lazy(() => integer).describe('The maximum number of folds for the cross-validation procedure.').optional(),
...
export const MlDataframeAnalyticsStatsHyperparameters = z.object({
  ...
  iteration: z.lazy(() => integer).describe('The number of iterations on the analysis.'),
...
export const MlDataframeAnalyticsStatsMemoryUsage = z.object({
  memory_reestimate_bytes: z.lazy(() => long).describe('This value is present when the status is hard_limit and it is a new estimate of how much memory the job needs.').optional(),
...
export const MlDataframeAnalytics = z.object({
  ...
  id: z.lazy(() => Id).describe('The unique identifier of the data frame analytics job.'),
...
export const MlGetRecordsRequest = z.object({
  job_id: z.lazy(() => Id).describe('Identifier for the anomaly detection job.').meta({ found_in: 'path' }),
  from: z.lazy(() => integer).describe('Skips the specified number of records.').optional().meta({ found_in: 'query' }),
  size: z.lazy(() => integer).describe('Specifies the maximum number of records to obtain.').optional().meta({ found_in: 'query' }),
  desc: z.boolean().describe('Refer to the description for the `desc` query parameter.').optional().meta({ found_in: 'body' }),
  end: z.lazy(() => DateTime).describe('Refer to the description for the `end` query parameter.').optional().meta({ found_in: 'body' }),
  exclude_interim: z.boolean().describe('Refer to the description for the `exclude_interim` query parameter.').optional().meta({ found_in: 'body' }),
  page: MlPage.optional().meta({ found_in: 'body' }),

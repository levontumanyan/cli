...
import { AcknowledgedResponseBase, DateTime, Duration, Field, Id, IndexName, Indices, Metadata, Names, RequestBase, Result, ScalarValue, double, integer, long } from './_types.ts'

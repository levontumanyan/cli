...
import { AcknowledgedResponseBase, DateTime, Duration, DurationValue, EpochTime, ErrorCause, Field, Fields, GeoShapeRelation, GrokPattern, Id, Ids, IndexName, Metadata, Name, Script, ScriptLanguage, ScriptSource, SortOrder, VersionNumber, VersionType, double, integer, long } from './_types.ts'
import type { ScriptShape, ScriptSourceShape } from './_types.ts'
...
export const IngestInferenceConfigRegression = z.object({
  results_field: z.lazy(() => Field).describe('The field that is added to incoming documents to contain the inference prediction.').optional(),
...
export const IngestInferenceConfigClassification = z.object({
  num_top_classes: z.lazy(() => integer).describe('Specifies the number of top class predictions to return.').optional(),
  num_top_feature_importance_values: z.lazy(() => integer).describe('Specifies the maximum number of feature importance values per document.').optional(),
  results_field: z.lazy(() => Field).describe('The field that is added to incoming documents to contain the inference prediction.').optional(),
  top_classes_results_field: z.lazy(() => Field).describe('Specifies the field to which the top classes are written.').optional(),
...
export const IngestAppendProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to be appended to. Supports template snippets.'),
  ...
  copy_from: z.lazy(() => Field).describe('The origin field which will be appended to `field`, cannot set `value` simultaneously.').optional(),
...
export const IngestAttachmentProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to get the base64 encoded field from.'),
  ...
  indexed_chars: z.lazy(() => long).describe('The number of chars being used for extraction to prevent huge fields. Use `-1` for no limit.').optional(),
  indexed_chars_field: z.lazy(() => Field).describe('Field name from which you can overwrite the number of chars being used for extraction.').optional(),
  ...
  target_field: z.lazy(() => Field).describe('The field that will hold the attachment information.').optional(),
...
export const IngestBytesProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to convert.'),
  ...
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the field is updated in-place.').optional()
...
export const IngestCefProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field containing the CEF message.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the `target_field` is \'cef\'').optional(),
...
export const IngestCircleProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  error_distance: z.lazy(() => double).describe('The difference between the resulting inscribed distance from center to side and the circle’s radius (measured in meters for `geo_shape`, unit-less for `shape`).'),
  field: z.lazy(() => Field).describe('The field to interpret as a circle. Either a string in WKT format or a map for GeoJSON.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  shape_type: IngestShapeType.describe('Which field mapping type is to be used when processing the circle: `geo_shape` or `shape`.'),
  target_field: z.lazy(() => Field).describe('The field to assign the polygon shape to By default, the field is updated in-place.').optional()
...
export const IngestCommunityIDProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  source_ip: z.lazy(() => Field).describe('Field containing the source IP address.').optional(),
  source_port: z.lazy(() => Field).describe('Field containing the source port.').optional(),
  destination_ip: z.lazy(() => Field).describe('Field containing the destination IP address.').optional(),
  destination_port: z.lazy(() => Field).describe('Field containing the destination port.').optional(),
  iana_number: z.lazy(() => Field).describe('Field containing the IANA number.').optional(),
  icmp_type: z.lazy(() => Field).describe('Field containing the ICMP type.').optional(),
  icmp_code: z.lazy(() => Field).describe('Field containing the ICMP code.').optional(),
  transport: z.lazy(() => Field).describe('Field containing the transport protocol name or number. Used only when the iana_number field is not present. The following protocol names are currently supported: eigrp, gre, icmp, icmpv6, igmp, ipv6-icmp, ospf, pim, sctp, tcp, udp').optional(),
  target_field: z.lazy(() => Field).describe('Output field for the community ID.').optional(),
  seed: z.lazy(() => integer).describe('Seed for the community ID hash. Must be between 0 and 65535 (inclusive). The seed can prevent hash collisions between network domains, such as a staging and production network that use the same addressing scheme.').optional(),
...
export const IngestConvertProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field whose value is to be converted.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the `field` is updated in-place.').optional(),
...
export const IngestCsvProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to extract data from.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  ...
  target_fields: z.lazy(() => Fields).describe('The array of fields to assign extracted values to.'),
...
export const IngestDateIndexNameProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to get the date or timestamp from.'),
...
export const IngestDateProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to get the date from.'),
  ...
  target_field: z.lazy(() => Field).describe('The field that will hold the parsed date.').optional(),
...
export const IngestDissectProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to dissect.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
...
export const IngestDotExpanderProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to expand into an object field. If set to `*`, all top-level fields will be expanded.'),
...
export const IngestEnrichProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field in the input document that matches the policies match_field used to retrieve the enrichment data. Supports template snippets.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  max_matches: z.lazy(() => integer).describe('The maximum number of matched documents to include under the configured target field. The `target_field` will be turned into a json array if `max_matches` is higher than 1, otherwise `target_field` will become a json object. In order to avoid documents getting too large, the maximum allowed value is 128.').optional(),
  ...
  target_field: z.lazy(() => Field).describe('Field added to incoming documents to contain enrich data. This field contains both the `match_field` and `enrich_fields` specified in the enrich policy. Supports template snippets.')
...
export const IngestFingerprintProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  fields: z.lazy(() => Fields).describe('Array of fields to include in the fingerprint. For objects, the processor hashes both the field key and value. For other fields, the processor hashes only the field value.'),
  target_field: z.lazy(() => Field).describe('Output field for the fingerprint.').optional(),
...
export const IngestForeachProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('Field containing array or object values.'),
...
export const IngestGeoGridProcessor = z.object({
  ...
  target_field: z.lazy(() => Field).describe('The field to assign the polygon shape to, by default, the `field` is updated in-place.').optional(),
  parent_field: z.lazy(() => Field).describe('If specified and a parent tile exists, save that tile address to this field.').optional(),
  children_field: z.lazy(() => Field).describe('If specified and children tiles exist, save those tile addresses to this field as an array of strings.').optional(),
  non_children_field: z.lazy(() => Field).describe('If specified and intersecting non-child tiles exist, save their addresses to this field as an array of strings.').optional(),
  precision_field: z.lazy(() => Field).describe('If specified, save the tile precision (zoom) as an integer to this field.').optional(),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
...
export const IngestGeoIpProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to get the ip address from for the geographical lookup.'),
  ...
  target_field: z.lazy(() => Field).describe('The field that will hold the geographical information looked up from the MaxMind database.').optional(),
...
export const IngestGrokProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to use for grok expression parsing.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  ...
  patterns: z.array(z.lazy(() => GrokPattern)).describe('An ordered list of grok expression to match and extract named captures with. Returns on the first expression in the list that matches.'),
...
export const IngestGsubProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to apply the replacement to.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
...
export const IngestHtmlStripProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The string-valued field to remove HTML tags from.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document,').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to By default, the `field` is updated in-place.').optional()
...
export const IngestInferenceProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  model_id: z.lazy(() => Id).describe('The ID or alias for the trained model, or the ID of the deployment.'),
  target_field: z.lazy(() => Field).describe('Field added to incoming documents to contain results objects.').optional(),
  field_map: z.record(z.lazy(() => Field), z.any()).describe('Maps the document field names to the known field names of the model. This mapping takes precedence over any default mappings provided in the model configuration.').optional(),
...
export const IngestJoinProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('Field containing array values to join.'),
  separator: z.string().describe('The separator character.'),
  target_field: z.lazy(() => Field).describe('The field to assign the joined value to. By default, the field is updated in-place.').optional()
...
export const IngestJsonProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to be parsed.'),
  target_field: z.lazy(() => Field).describe('The field that the converted structured object will be written into. Any existing content in this field will be overwritten.').optional()
...
export const IngestKeyValueProcessor = z.object({
  ...
  field: z.lazy(() => Field).describe('The field to be parsed. Supports template snippets.'),
  ...
  target_field: z.lazy(() => Field).describe('The field to insert the extracted keys into. Defaults to the root of the document. Supports template snippets.').optional(),
...
export const IngestLowercaseProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to make lowercase.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the field is updated in-place.').optional()
...
export const IngestNetworkDirectionProcessor = z.object({
  ...
  source_ip: z.lazy(() => Field).describe('Field containing the source IP address.').optional(),
  destination_ip: z.lazy(() => Field).describe('Field containing the destination IP address.').optional(),
  target_field: z.lazy(() => Field).describe('Output field for the network direction.').optional(),
  ...
  internal_networks_field: z.lazy(() => Field).describe('A field on the given document to read the internal_networks configuration from.').optional(),
  ignore_missing: z.boolean().describe('If true and any required fields are missing, the processor quietly exits without modifying the document.').optional()
...
export const IngestPipelineProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  name: z.lazy(() => Name).describe('The name of the pipeline to execute. Supports template snippets.'),
...
export const IngestRedactProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to be redacted'),
  patterns: z.array(z.lazy(() => GrokPattern)).describe('A list of grok expressions to match and redact named captures with'),
...
export const IngestRegisteredDomainProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('Field containing the source FQDN.'),
  target_field: z.lazy(() => Field).describe('Object field containing extracted domain components. If an empty string, the processor adds components to the document’s root.').optional(),
  ignore_missing: z.boolean().describe('If true and any required fields are missing, the processor quietly exits without modifying the document.').optional()
...
export const IngestRemoveProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Fields).describe('Fields to be removed. Supports template snippets.'),
  keep: z.lazy(() => Fields).describe('Fields to be kept. When set, all fields other than those specified are removed.').optional(),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional()
...
export const IngestRenameProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to be renamed. Supports template snippets.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The new name of the field. Supports template snippets.')
...
export const IngestScriptProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  id: z.lazy(() => Id).describe('ID of a stored script. If no `source` is specified, this parameter is required.').optional(),
  lang: z.lazy(() => ScriptLanguage).describe('Script language.').optional(),
...
export const IngestSetProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  copy_from: z.lazy(() => Field).describe('The origin field which will be copied to `field`, cannot set `value` simultaneously. Supported data types are `boolean`, `number`, `array`, `object`, `string`, `date`, etc.').optional(),
  field: z.lazy(() => Field).describe('The field to insert, upsert, or update. Supports template snippets.'),
...
export const IngestSetSecurityUserProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to store the user information into.'),
...
export const IngestSortProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to be sorted.'),
  order: SortOrder.describe('The sort order to use. Accepts `"asc"` or `"desc"`.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the sorted value to. By default, the field is updated in-place.').optional()
...
export const IngestSplitProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to split.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  ...
  target_field: z.lazy(() => Field).describe('The field to assign the split value to. By default, the field is updated in-place.').optional()
...
export const IngestTrimProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The string-valued field to trim whitespace from.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the trimmed value to. By default, the field is updated in-place.').optional()
...
export const IngestUppercaseProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to make uppercase.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the field is updated in-place.').optional()
...
export const IngestUriPartsProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('Field containing the URI string.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  ...
  target_field: z.lazy(() => Field).describe('Output field for the URI object.').optional()
...
export const IngestUrlDecodeProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field to decode.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.').optional(),
  target_field: z.lazy(() => Field).describe('The field to assign the converted value to. By default, the field is updated in-place.').optional()
...
export const IngestUserAgentProcessor = z.object({
  ...
  get on_failure () { return IngestProcessorContainer.array().describe('Handle failures for the processor.').optional() },
  tag: z.string().describe('Identifier for the processor. Useful for debugging and metrics.').optional(),
  field: z.lazy(() => Field).describe('The field containing the user agent string.'),
  ignore_missing: z.boolean().describe('If `true` and `field` does not exist, the processor quietly exits without modifying the document.').optional(),
  ...
  target_field: z.lazy(() => Field).describe('The field that will be filled with the user agent details.').optional(),
...
export const IngestPutPipelineRequest = z.object({
  id: z.lazy(() => Id).describe('ID of the ingest pipeline to create or update.').meta({ found_in: 'path' }),
  master_timeout: z.lazy(() => Duration).describe('Period to wait for a connection to the master node. If no response is received before the timeout expires, the request fails and returns an error.').optional().meta({ found_in: 'query' }),
  timeout: z.lazy(() => Duration).describe('Period to wait for a response. If no response is received before the timeout expires, the request fails and returns an error.').optional().meta({ found_in: 'query' }),
  if_version: z.lazy(() => integer).describe('Required version for optimistic concurrency control for pipeline updates').optional().meta({ found_in: 'query' }),
  _meta: z.lazy(() => Metadata).describe('Optional metadata about the ingest pipeline. May have any contents. This map is not automatically generated by Elasticsearch.').optional().meta({ found_in: 'body' }),
  ...
  version: z.lazy(() => VersionNumber).describe('Version number used by external systems to track ingest pipelines. This parameter is intended for external systems only. Elasticsearch does not use or validate pipeline version numbers.').optional().meta({ found_in: 'body' }),
...
export const IngestPutPipelineResponse = z.lazy(() => AcknowledgedResponseBase).meta({ id: 'IngestPutPipelineResponse' })
